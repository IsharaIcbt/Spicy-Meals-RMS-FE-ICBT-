...
export const CREATE_ACCOUNT_PATH = `${ROUTE_PATH}/register`
...
export const RESERVATION_DETAILS_PATH = `${ROUTE_PATH}/reservations/details/:id`
export const ORDERS_DETAILS_PATH = `${ROUTE_PATH}/my-orders/details/:id`
